...
# -*- coding: utf-8 -*-
"""
Three-Phase Spring AI Scraping Script

Executes all three Spring AI scraping configurations:
- Phase 1: spring_ai_starter (Quick Start - 5 min)
- Phase 2: spring_ai_official (Complete Framework - 20 min)
- Phase 3: spring_ai_alibaba (Full Ecosystem - 60 min)

Usage:
    python run_three_phases.py
    python run_three_phases.py --phase 1      # Run only phase 1
    python run_three_phases.py --skip-existing # Skip if output exists
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Run three-phase Spring AI scraping',
...
Examples:
  ...
  python run_three_phases.py --phase 2 --phase 3
    ...
    print("=" * 70)
    print("THREE-PHASE SPRING AI SCRAPING")
    print("=" * 70)
